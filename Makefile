...
build_mxpt_v120: TARGETFLAGS= -DTARGET_MXPT_V120 $(DEFINES)
# Set the linker script
build_mxpt_v120: LDFLAGS +=-T$(ST_LIB)/c_only_md_high_density.ld
build_mxpt_v120: elf bin lss sym
copy_mxpt_v120:
	@echo
...
copy_stlinkv2_m1:
	...
	@echo "Copying to binaries folder"
	@echo
	cp $(TARGET).bin binaries/MXLS_STLINKV2_M1.bin
	@echo
